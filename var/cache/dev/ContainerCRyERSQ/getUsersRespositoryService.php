...
// Returns the private 'App\Repository\UsersRespository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\UsersRespository.php';

return $this->privates['App\Repository\UsersRespository'] = new \App\Repository\UsersRespository(($this->services['doctrine'] ?? $this->getDoctrineService()));
