...
// Returns the private 'App\Repository\Window_user_statsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\Window_user_statsRepository.php';

return $this->privates['App\Repository\Window_user_statsRepository'] = new \App\Repository\Window_user_statsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
