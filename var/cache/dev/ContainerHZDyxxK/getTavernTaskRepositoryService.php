...
// Returns the private 'App\Repository\TavernTaskRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\TavernTaskRepository.php';

return $this->privates['App\Repository\TavernTaskRepository'] = new \App\Repository\TavernTaskRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
