...
$a->setNamespace('sf_orm_default_37a22b9c387f37f29126a6d4ff93167effb5328ecf676f2c197491308e4ce31b');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_37a22b9c387f37f29126a6d4ff93167effb5328ecf676f2c197491308e4ce31b');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_37a22b9c387f37f29126a6d4ff93167effb5328ecf676f2c197491308e4ce31b');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ActiveTaskRepository' => function () {
    return ($this->privates['App\Repository\ActiveTaskRepository'] ?? $this->load(__DIR__.'/getActiveTaskRepositoryService.php'));
}, 'App\\Repository\\TavernTaskRepository' => function () {
    return ($this->privates['App\Repository\TavernTaskRepository'] ?? $this->load(__DIR__.'/getTavernTaskRepositoryService.php'));
}, 'App\\Repository\\UsersRespository' => function () {
    return ($this->privates['App\Repository\UsersRespository'] ?? $this->load(__DIR__.'/getUsersRespositoryService.php'));
}, 'App\\Repository\\Window_user_statsRepository' => function () {
    return ($this->privates['App\Repository\Window_user_statsRepository'] ?? $this->load(__DIR__.'/getWindowUserStatsRepositoryService.php'));
}))));
